...
// uint32 hp = 2;
inline void C_TEST::clear_hp() {
  _impl_.hp_ = 0u;
}
inline uint32_t C_TEST::_internal_hp() const {
  return _impl_.hp_;
}
inline uint32_t C_TEST::hp() const {
  // @@protoc_insertion_point(field_get:Protocol.C_TEST.hp)
  return _internal_hp();
}
inline void C_TEST::_internal_set_hp(uint32_t value) {
  
  _impl_.hp_ = value;
}
inline void C_TEST::set_hp(uint32_t value) {
  _internal_set_hp(value);
  // @@protoc_insertion_point(field_set:Protocol.C_TEST.hp)
}

// uint32 attack = 3;
inline void C_TEST::clear_attack() {
  _impl_.attack_ = 0u;
}
inline uint32_t C_TEST::_internal_attack() const {
  return _impl_.attack_;
}
inline uint32_t C_TEST::attack() const {
  // @@protoc_insertion_point(field_get:Protocol.C_TEST.attack)
  return _internal_attack();
}
inline void C_TEST::_internal_set_attack(uint32_t value) {
  
  _impl_.attack_ = value;
}
inline void C_TEST::set_attack(uint32_t value) {
  _internal_set_attack(value);
  // @@protoc_insertion_point(field_set:Protocol.C_TEST.attack)
}

// repeated .Protocol.BuffData buffs = 4;
inline int C_TEST::_internal_buffs_size() const {
  return _impl_.buffs_.size();
}
inline int C_TEST::buffs_size() const {
  return _internal_buffs_size();
}
inline ::Protocol::BuffData* C_TEST::mutable_buffs(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.C_TEST.buffs)
  return _impl_.buffs_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::BuffData >*
C_TEST::mutable_buffs() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.C_TEST.buffs)
  return &_impl_.buffs_;
}
inline const ::Protocol::BuffData& C_TEST::_internal_buffs(int index) const {
  return _impl_.buffs_.Get(index);
}
inline const ::Protocol::BuffData& C_TEST::buffs(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.C_TEST.buffs)
  return _internal_buffs(index);
}
inline ::Protocol::BuffData* C_TEST::_internal_add_buffs() {
  return _impl_.buffs_.Add();
}
inline ::Protocol::BuffData* C_TEST::add_buffs() {
  ::Protocol::BuffData* _add = _internal_add_buffs();
  // @@protoc_insertion_point(field_add:Protocol.C_TEST.buffs)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::BuffData >&
C_TEST::buffs() const {
  // @@protoc_insertion_point(field_list:Protocol.C_TEST.buffs)
  return _impl_.buffs_;
}
