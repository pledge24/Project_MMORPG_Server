...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_TEST, _impl_.hp_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_TEST, _impl_.attack_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_TEST, _impl_.buffs_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::S_TEST)},
  { 10, -1, -1, sizeof(::Protocol::C_TEST)},
};
...
void C_TEST::InternalSwap(C_TEST* other) {
  ...
  _impl_.buffs_.InternalSwap(&other->_impl_.buffs_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(C_TEST, _impl_.attack_)
      + sizeof(C_TEST::_impl_.attack_)
      - PROTOBUF_FIELD_OFFSET(C_TEST, _impl_.id_)>(
          reinterpret_cast<char*>(&_impl_.id_),
          reinterpret_cast<char*>(&other->_impl_.id_));
}
